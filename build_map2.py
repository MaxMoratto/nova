...
<style>
  ...
  *{box-sizing:border-box}html,body{height:100%}
  ...
  .seat{fill:rgba(255,255,255,0.001);stroke:transparent;stroke-width:42;cursor:pointer;transition:fill .1s,stroke .1s}
  .seat:hover{fill:rgba(242,210,30,0.30);stroke:rgba(242,210,30,0.95)}
  .seat.sel{fill:rgba(37,211,102,0.5);stroke:#25d366;stroke-width:34}
  .seat.vendido{fill:rgba(12,13,18,0.62);stroke:#e11d2a;stroke-width:16;cursor:not-allowed}
  .seats.dimmed .seat:not(.hl){opacity:.18}
  .seat.hl:not(.sel):not(.vendido){fill:rgba(255,255,255,.14);stroke:#fff;stroke-width:40;stroke-opacity:.95;animation:hlpulse 1s ease-in-out infinite}
...
<div class="app">
  ...
  <aside class="side">
    <div class="side-head"><h1>Elige tus lugares</h1><div class="meta"><span><span class="dotr"></span>11 SEP 2026</span><span>Golden Paradise Casino · CDMX</span></div></div>
...
const CONFIG = {
  whatsapp:"5215633353642", evento:"NOVA - 11 SEP 2026 - Golden Paradise Casino", spei:{beneficiario:"",banco:"",clabe:""},
